...
Route::namespace('Auth')->group(function () {
    ...
    Route::post('driver/validate-driver', 'LoginController@validateDriver');
    ...
    Route::namespace('Registration')->group(function () {
        ...
        // send otp
        Route::post('send-mobile-otp', 'UserRegistrationController@sendMobileOTP');
        // Validate the email registration OTP.
        Route::post('validate-mobile-otp', 'UserRegistrationController@validateMobileOTP');
