...
class SettingsSeeder extends Seeder
{
    ...
    protected $settings_from_seeder = [
        ...
        SettingSlug::GST_FOR_RENTAL_VEHICLES => [
            'category'=>SettingCategory::TRIP_SETTINGS,
            'value' => 18,
            'field' => SettingValueType::TEXT,
            'option_value' => null,
        ...
        SettingSlug::MINIMUM_WALLET_AMOUNT_FOR_WITHDRAWAL => [
            'category'=>SettingCategory::WALLET,
            'value' => 500,
            'field' => SettingValueType::TEXT,
            'option_value' => null,
        ...
        SettingSlug::DRIVER_COMMISSION_TYPE => [
            'category'=>SettingCategory::TRIP_SETTINGS,
            'value' => 30,
            'field' => SettingValueType::SELECT,
            'option_value' => '{"commision":"commision","subscription":"subscription"}',
            'group_name' => null,
        ],  
        SettingSlug::SUBSCRIPTION_GST=> [
            'category'=>SettingCategory::TRIP_SETTINGS,
            'value' => 18,
            'field' => SettingValueType::TEXT,
            'group_name' => null,
        ],                
         SettingSlug::DRIVER_DAILY_SUBSCRIPTION_AMOUNT => [
            'category'=>SettingCategory::TRIP_SETTINGS,
            'value' => 10,
            'field' => SettingValueType::TEXT,
            'option_value' => null,
        ...
        SettingSlug::DRIVER_WEEKLY_SUBSCRIPTION_AMOUNT => [
            'category'=>SettingCategory::TRIP_SETTINGS,
            'value' => 20,
            'field' => SettingValueType::TEXT,
            'option_value' => null,
        ...
        SettingSlug::DRIVER_MONTHLY_SUBSCRIPTION_AMOUNT => [
            'category'=>SettingCategory::TRIP_SETTINGS,
            'value' => 30,
            'field' => SettingValueType::TEXT,
            'option_value' => null,
         ...
         SettingSlug::DRIVER_YEARLY_SUBSCRIPTION_AMOUNT => [
            'category'=>SettingCategory::TRIP_SETTINGS,
            'value' => 100,
            'field' => SettingValueType::TEXT,
            'option_value' => null,
        ...
        SettingSlug::USER_CONFIRM_BOOKING_TIMEOUT => [
            'category'=>SettingCategory::TRIP_SETTINGS,
            'value' => 30,
            'field' => SettingValueType::TEXT,
            'option_value' => null,
         ...
         SettingSlug::USER_CAN_MAKE_A_RIDE_FOR_X_DAYS => [
            'category'=>SettingCategory::TRIP_SETTINGS,
            'value' => 30,
            'field' => SettingValueType::TEXT,
            'option_value' => null,
    ...
    //General category settings
        SettingSlug::DISPATCHER_REQUEST_LIST_ACCESS => [
        ...
        SettingSlug::DISPATCHER_BOOK_LATER_ACCESS => [
            'category'=>SettingCategory::GENERAL,
            'value' => 1,
             'field' => SettingValueType::SELECT,
             'option_value' => '{"yes":1,"no":0}',
        ...
        SettingSlug::DISPATCHER_DRIVER_LIST_ACCESS => [
            'category'=>SettingCategory::GENERAL,
            'value' => 1,
             'field' => SettingValueType::SELECT,
             'option_value' => '{"yes":1,"no":0}',
        ...
        SettingSlug::DISPATCHER_MANUAL_ASSIGN_ACCESS => [
            'category'=>SettingCategory::GENERAL,
            'value' => 1,
             'field' => SettingValueType::SELECT,
             'option_value' => '{"yes":1,"no":0}',
        ...
        SettingSlug::DISPATCHER_ZONE_ACCESS => [
            'category'=>SettingCategory::GENERAL,
            'value' => 1,
             'field' => SettingValueType::SELECT,
             'option_value' => '{"yes":1,"no":0}',
        ...
        SettingSlug::SHOW_BANK_INFO_FEATURE_ON_MOBILE_APP => [
         ...
         SettingSlug::WHATS_APP_NUMBER_DRIVER => [
            'category'=>SettingCategory::GENERAL,
            'value' => '0000000000',
            'field' => SettingValueType::TEXT,
            'option_value' => null,
         ...
         SettingSlug::WHATS_APP_NUMBER_DRIVER_DOCUMENT_PAGE => [
            'category'=>SettingCategory::GENERAL,
            'value' => '0000000000',
            'field' => SettingValueType::TEXT,
            'option_value' => null,
        ...
        SettingSlug::DRIVER_CANCELLATION_AMOUNT_TO_BLOCK_SCREEN => [
            'category'=>SettingCategory::WALLET,
            'value' => 3,
            'field' => SettingValueType::TEXT,
            'option_value' => null,
        ...
        SettingSlug::USER_CANCELLATION_AMOUNT_TO_BLOCK_SCREEN => [
            'category'=>SettingCategory::WALLET,
            'value' => 3,
            'field' => SettingValueType::TEXT,
            'option_value' => null,
...
/*ccavenue*/
        ...
        SettingSlug::WORKING_KEY=> [
            'category'=>SettingCategory::INSTALLATION,
            'value' => '7468EC8D14D20CB9D8253169A756E2F5',
            'field' => SettingValueType::TEXT,
            'option_value' => null,
            'group_name' => SettingSubGroup::CCAVENUE_SETTINGS,
        ],
        ...
        SettingSlug::RESPONSE_URL=> [
            'category'=>SettingCategory::INSTALLATION,
            'value' => 'https://ddatab.com/api/v1/ccavenue/webhook',
            'field' => SettingValueType::TEXT,
            'option_value' => null,
            'group_name' => SettingSubGroup::CCAVENUE_SETTINGS,
        ],        
        ...
        SettingSlug::ENABLE_KASHIER => [
            'category'=>SettingCategory::INSTALLATION,
            'value' => '1',
            'field' => SettingValueType::SELECT,
            'option_value' => '{"yes":1,"no":0}',
            'group_name' => SettingSubGroup::KASHIER_SETTINGS,
        ],
        SettingSlug::KASHIER_ENVIRONMENT => [
            'category'=>SettingCategory::INSTALLATION,
            'field' => SettingValueType::SELECT,
            'option_value' => '{"test":"test","production":"production"}',
            'group_name' => SettingSubGroup::KASHIER_SETTINGS,
        ],
        SettingSlug::KASHIER_TEST_SECRET_KEY => [
            'category'=>SettingCategory::INSTALLATION,
            'value' => '1e26a2a6-6f73-454b-966c-c199f0ce1035',
            'field' => SettingValueType::TEXT,
            'option_value' => null,
            'group_name' => SettingSubGroup::KASHIER_SETTINGS,
        ],
        SettingSlug::KASHIER_PRODUCTION_SECRET_KEY => [
            'category'=>SettingCategory::INSTALLATION,
            'value' => 'ab5fda52-ca9f-4a34-bdac-8a17bb33dd04',
            'field' => SettingValueType::TEXT,
            'option_value' => null,
            'group_name' => SettingSubGroup::KASHIER_SETTINGS,
        ],
...
// sms gateway
        SettingSlug::SMSINDIAHUB_API_KEY => [
            'category'=>SettingCategory::SMS_SETTINGS,
            'value' => 'Pte4eXLw90iLEGNTQqoPLQ',
            'field' => SettingValueType::TEXT,
            'option_value' => null,
            'group_name' => null,
        ],          
        SettingSlug::SMSINDIAHUB_SENDER_ID => [
            'category'=>SettingCategory::SMS_SETTINGS,
            'value' => 'DUBUAT',
            'field' => SettingValueType::TEXT,
            'option_value' => null,
...
// exotel gateway
        SettingSlug::EXOTEL_ACCOUNT_SID => [
            'category'=>SettingCategory::EXOTEL_SETTINGS,
            'value' => 'dubudubu1',
            'field' => SettingValueType::TEXT,
            'option_value' => null,
            'group_name' => null,
        ],          
        SettingSlug::EXOTEL_API_KEY => [
            'category'=>SettingCategory::EXOTEL_SETTINGS,
            'value' => '60b1f0b8a7fbf9ddb8ef4fbd7c54f3bbfaf966d60423ce4c',
            'field' => SettingValueType::TEXT,
            'option_value' => null,
            'group_name' => null,
        ], 
        SettingSlug::EXOTEL_API_TOKEN => [
            'category'=>SettingCategory::EXOTEL_SETTINGS,
            'value' => '8c7339024eb6dfd5281f4f4b2db1109790fa592bd1934107',
            'field' => SettingValueType::TEXT,
            'option_value' => null,
            'group_name' => null,
        ], 
        SettingSlug::EXOTEL_SUBDOMAIN => [
            'category'=>SettingCategory::EXOTEL_SETTINGS,
            'value' => 'api.exotel.com',
            'field' => SettingValueType::TEXT,
            'option_value' => null,
            'group_name' => null,
        ],  
       SettingSlug::EXOTEL_CALLER_ID => [
            'category'=>SettingCategory::EXOTEL_SETTINGS,
            'value' => '09513886363',
            'field' => SettingValueType::TEXT,
            'option_value' => null,
       ...
       SettingSlug::EXOTEL_VIRTUAL_NUMBER => [
            'category'=>SettingCategory::EXOTEL_SETTINGS,
            'value' => '04448134762',
            'field' => SettingValueType::TEXT,
            'option_value' => null,
