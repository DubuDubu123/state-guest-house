...
">
    ...
    <thead>
        <tr>
            ...
            <th style="font-size:12px">Officer's ID</th>
            <th style="font-size:12px">Officer's Name</th>
            <th style="font-size:12px">Check-in</th>
            <th style="font-size:12px">Guest Type</th>
            <th style="font-size:12px">Booked By</th>
    ...
    <tbody>
        ...
        @forelse($results as $key => $result)
            <tr>
                ...
                <td style="font-size:12px">{{$result->booking_id}} </td>
                <td style="font-size:12px">{{$result->user->userid}} </td>
                <td style="font-size:12px">{{$result->user->name}} </td>
                <td style="font-size:12px"><?php echo date('Y-m-d', strtotime($result->checkin_date));?></td>
                <td style="font-size:12px">{{ucfirst($result->guest_type)}}</td>
                <td style="font-size:12px">{{$result->booked_user->userid}} </td>
                ...
                <td style="font-size:12px">₹{{$result->tariff}}</td> 
            </tr>
        @empty
            <tr>
                <td colspan="11">
