  ...
  <head>
    ...
    <body>
      ...
      <div class="card1" style="border:1px solid #646464;border-radius:20px; height:300px; width:500px;padding:20px; background: white; margin:0 0 30px 0;display:grid;place-items:center;-webkit-box-shadow: 10px 10px 9px -7px rgba(0,0,0,0.45);
-moz-box-shadow: 10px 10px 9px -7px rgba(0,0,0,0.45);
box-shadow: 10px 10px 9px -7px rgba(0,0,0,0.45);">
      <img src="{{asset('assets/img/remove.png')}}" width="100px" style="margin-top:20px;" class="img-fluid" alt="">
        <h4 style="margin-bottom:40px;font-size:40px">Payment Failed</h4> 
        <p style="font-size:20px;margin-bottom:40px;">Unable to process the payment</p> 
