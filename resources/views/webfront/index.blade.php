...
<section class="slice slice-lg bg-gradient-primary bg-cover py-10" style="background: var(--logo-gradient);background-image: url('{{ asset($p.$data->afrbimage) }}');width: 100%;height: 100%;">
  <div class="container">
