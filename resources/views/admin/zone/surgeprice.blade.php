        ...
        <div class="col-sm-12">
            ...
            <table class="table surgeTable" id="table">
                <thead>
                    ...
                    <!-- <th>@lang('view_pages.days') <span class="text-danger">*</span></th> -->
...
<!--                                 <td>
                                <div class="form-group">                               
                                <select name="days[{{$k}}][]" id="days" class="form-control select2"  multiple="multiple" data-placeholder="Select Day">
                                                @foreach ($days as $d=>$day)                             
                                                   
                                                    <option value="{{ $day }}" {{ (in_array($day, old('day', [])) || $surgeValue->zoneSurgeDays()->where('week_day',$day)->pluck('week_day')->first()) ? 'selected' : '' }}>{{ ($day) }}</option>
                                                @endforeach
                                            </select>
                                ...
                                <td>
                                    <div class="form-group">
                                            <input class="form-control" type="number" id="name" name="price[]" value="{{old('price.'.$k,$surgeValue->value)}}" required="" placeholder="@lang('view_pages.enter_price')">
...
<!--                                 <td>
                                <div class="form-group">
                                            <select name="days[0][]" id="days" class="form-control select2"  multiple="true" data-placeholder="Select Day">
                                                @foreach ($days as $day)
   ...
   <script>
        ...
        $(document).on("click",".add_row",function(){
            ...
            console.log(tableRowCount);
                ...
                // append_row += '<td>\
                //                 <div class="form-group">\
                //                             <select name="days['+tableRowCount+'][]" id="days" class="form-control select2"  multiple="multiple" data-placeholder="Select Day">\
                //                             @foreach ($days as $day)\
