...
<div class="col-sm-12">
    ...
    <input name="search-box" id="search-box" class="form-control controls" type="text" placeholder="@lang('view_pages.search')" />
<span class="text-danger">{{ $errors->first('search-box') }}</span>
