                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover">
                                            <thead>
                                                ...
                                                <th style="width: 5% !important;"> S.No
                                                        <span style="float: right;"></span>
                                                    </th>

                                                    <th style="width: 10% !important;"> Booking ID
                                                        <span style="float: right;"></span>
                                                    </th>
                                                    <th style="width: 10%;"> Booked By
                                                        <span style="float: right;"></span>
                                                    </th>
                                                    <th style="width: 13% !important;"> Officer's Name
                                                        <span style="float: right;"></span>
                                                    </th>
                                                    <!-- <th> Tansport Type<span style="float: right;">
</span>
</th> -->
                                                    <th style="width: 13% !important;"> Check-in 
                                                        <span style="float: right;"> </span>
                                                    </th> 
                                                    <th style="width: 12% !important;"> Guest Type
                                                        <span style="float: right;"></span>
                                                    </th>
                                                    <th style="width: 12% !important;"> Status
                                                        <span style="float: right;"></span>
                                                    </th>
                                                    <th style="width: 15% !important;"> Payment Status
                                                        <span style="float: right;"></span>
                                                    </th>

                                                    <th style="width: 10% !important;"> Action<span style="float: right;">
</span>
                                                    </th>
...
<td><a class="dropdown-item" href="{{url('party-booking/view',$result->id)}}"><span class="label label-success">View   </span></a> </td> 
</tr>
@endforeach
@endif
</tbody>
