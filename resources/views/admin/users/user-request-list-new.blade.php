...
<div class="col-sm-12">
 ...
 <!-- Modal -->
                     ...
                     <div id="js-request-partial-target" class="table-responsive">
                        <include-fragment src="{{$items}}/fetch">
...
console.log(items);
            $(function() {
                ...
                $('#search').on('click', function(e) {
                    ...
                    fetch(''+items+'/fetch?search=' + search_keyword)
                ...
                $('.filter, .resetfilter').on('click', function() {
                    ...
                    let className = $(this);
                    let query = ''; // Initialize query outside the loop
                    ...
                    fetch('/users/request-list/'+items+'/fetch?'+query)
                        .then(response => response.text())
                        .then(html => {
                            document.querySelector('#js-request-partial-target').innerHTML = html
                        });
