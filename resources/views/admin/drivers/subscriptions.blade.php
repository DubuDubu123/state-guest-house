		...
		<div class="box-body no-padding">
		    <div class="table-responsive">
		      <table class="table table-hover">
				...
				<th> @lang('view_pages.subscription_type')
				<span style="float: right;">
				</span>
				</th>

				<th> @lang('view_pages.subscription_amount')
				<span style="float: right;">
				</span>
				</th>

				<th> @lang('view_pages.expiry_date')
				<span style="float: right;">
				</span>
				</th>
				...
				<td> {{$result->subscription_type}}</td>

				<td> {{$result->paid_amount}}</td>

				<td> {{$result->getConvertedExpiredAtYearAttribute() }}</td>
				...
				<td>	
				    ...
				    <div class="dropdown-menu" x-placement="bottom-start">	
				      <!-- <a class="dropdown-item" href="{{url('drivers/subscription-invoice',$result->id)}}">
				            <i class="fa fa-pencil"></i>@lang('view_pages.view')
				      </a> -->

				        <a class="dropdown-item sweet-delete" href="{{url('drivers/subscription-invoice/delete',$result->id)}}">
