...
@if($result->approve == 0 && $result->is_deleted == 0)
<img src="https://ddatab.com/images/Disapproved.png" alt="" style=" width: 60px; height: 60px;">
@elseif($result->approve == 1 && $result->is_deleted == 0)
...
@elseif($result->approve == 3)
<img src="https://ddatab.com/images/onboarding.png" alt="" style=" width: 60px; height: 60px;">
@endif
...
</div><div class="data" style="position: absolute;/* right: 10px; */background: blue;display: inline-block;height: 35px;width: 40px;cursor: pointer;border-radius: 3px;">
...
<script>
     $(document).on('change', '.online-toggle', function() {
        ...
        $.ajax({
            url: "https://ddatab.com/drivers/free_trail", // Replace with your Laravel route name or endpoint
            method: 'POST',
            data: {
                driver_id: userId,
    ...
    $(document).on('change', '.online-toggle1', function() {
        ...
        $.ajax({
            url: "https://ddatab.com/drivers/welcome_call", // Replace with your Laravel route name or endpoint
            method: 'POST',
            data: {
                driver_id: userId,
                status: isChecked ? '1' : '0'
