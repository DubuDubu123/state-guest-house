                                ...
                                <div class="col-6">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" id="vehicle_year" name="vehicle_year" value="{{old('vehicle_year', $item->vehicle_year)}}" required="" placeholder="@lang('view_pages.enter') @lang('view_pages.vehicle_year')">
