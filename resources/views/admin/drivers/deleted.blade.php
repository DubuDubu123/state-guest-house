...
<!--                             <div class="col-5 col-md-1 text-left">
                    ...
                    <div id="js-deleted-partial-target">
            ...
            $(function() {
                $('body').on('click', '.pagination a', function(e) {
                    ...
                    $.get(url, $('#search').serialize(), function(data) {
                        $('#js-deleted-partial-target').html(data);
                    });
                });
                ...
                $('#search').on('click', function(e) {
                    ...
                    fetch('search?search=' + search_keyword)
                        ...
                        .then(html => {
                            document.querySelector('#js-deleted-partial-target').innerHTML = html
                        });
                });
                    ...
                    if (isConfirm) {
                        ...
                        $.ajax({
                            ...
                            success: function(res) {
                                ...
                                fetch('fetch/deleted-drivers?search=' + search_keyword + '&' + query)
                                    .then(response => response.text())
                                    .then(html => {
                                        document.querySelector('#js-deleted-partial-target')
                                            .innerHTML = html
                                    });
