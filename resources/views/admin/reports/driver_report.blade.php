                ...
                <div class="box">
                    ...
                    <form method="post" class="form-horizontal" action="{{ url('reports/download') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                      <div class="form-group">
                                            <label for="admin_id">@lang('view_pages.vehicle_type')
                                                <span class="text-danger">*</span>
                                            </label>
                                            <select name="vehicle_type[]" class="form-control select2" id="multiple-select-field" data-placeholder="Select Types" multiple>
