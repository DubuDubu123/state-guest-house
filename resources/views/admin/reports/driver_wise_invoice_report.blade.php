            ...
            <div class="col-12">
                <div class="box">
                    ...
                    <form method="post" class="form-horizontal" action="{{ url('reports/download') }}">
                        @csrf
                        <input type="hidden" name="model" value="DriverWiseInvoice">

                        <div class="row">

                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="driver">@lang('view_pages.driver')</label>
                                    <select name="driver_id" id="driver" class="form-control" required>
                                        <option value="" selected >@lang('view_pages.select_driver')</option>
                                        @foreach ($drivers as $type)
                                            <option value="{{ $type->id }}">{{ $type->user->username }}</option>
                                        @endforeach
                                    </select>
                          ...
                          <div class="col-md-6">
                                <div class="form-group">
                                    <label for="invoice_type">@lang('view_pages.invoice_type') </label>
                                    <select name="invoice_type" id="invoice_type" class="form-control">
                                        <option value="subscription">@lang('view_pages.subscription')</option>
                                        <option value="get">@lang('view_pages.get')</option>
