            ...
            <div class="col-12">
                <div class="box">
                    ...
                    <form method="post" class="form-horizontal" action="{{ url('reports/download') }}">
                        @csrf
                        <input type="hidden" name="model" value="DriverInvoice">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="status" id="status" class="form-control" required>
                                        ...
                                        <option value="1">@lang('view_pages.sent')</option>
                                        <option value="2">@lang('view_pages.pending')</option>
                                        <option value="0">@lang('view_pages.received')</option>
