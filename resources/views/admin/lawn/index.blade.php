                ...
                <div class="box" style="padding: 15px 0px 15px 20px;">
                        <div class="box-header with-border">
                            <div style="color:black;font-size:18px">
                                <h5 class="font-weight-600 p-5" style="color:black;font-size:21px">Lawn Management </h5>
                            </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="box p-5" style="text-align: left;border-radius:10px;padding-left: 25px !important;background: #fff !important;">
                                        <div style="color:black;font-size:18px;margin-top: 20px;">
                                            <h5 class="font-weight-600 p-5" style="color:black;font-size:17px">Book Lawn</h5>
                                            <form id="lawn-booking" method="post" action="">
                                                @csrf
...
@endif
                                            <div class="row" style="padding: 20px;"> 
                                                    <div class="col-md-3 col-sm-6" style="margin-left: 15px;  margin-right: 15px;  ">
                                                        <div class="form-group">
    ...
    <span class="party-msg" style="  font-size: 13px;  position: absolute;top: -40px;width: 351px; left: 48px;font-weight: 800; padding: 6px;"></span>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-12">
                    <button class="btn btn-primary btn-sm m-5 book-now" type="button">Book Now</button>
                                                            </div>
                                                        </div>
                                                    </div>
        </form>
...
<div id="js-types-partial-target" style=" width: 100%;">
                                <include-fragment src="lawn/fetch">
