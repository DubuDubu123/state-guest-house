                                                   ...
                                                   {{--  <div class="col-sm-6 float-left mb-md-3">
                                                    ...
                                                    <div class="col-sm-6 float-left mb-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" type="text" id="aadhar_number" name="aadhar_number" value="{{ old('aadhar_number',$item->aadhar_number) }}" required="" placeholder="@lang('view_pages.enter') @lang('view_pages.aadhar_number')">
