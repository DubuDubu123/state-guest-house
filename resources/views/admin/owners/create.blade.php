...
<div class="col-sm-6 float-left mb-md-3">
<div class="form-group">
<label for="aadhar_number">@lang('view_pages.aadhar_number') <span
class="text-danger">*</span></label>
<input class="form-control" type="text" id="aadhar_number"
name="aadhar_number" value="{{ old('aadhar_number') }}"
required=""
placeholder="@lang('view_pages.enter') @lang('view_pages.aadhar_number')">
<span
class="text-danger">{{ $errors->first('aadhar_number') }}</span>
</div>
</div>
