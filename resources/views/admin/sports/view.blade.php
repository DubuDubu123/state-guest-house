...
">{{$booking->user->address}} </span></p>
                                ...
                                <div class="bio-row">
                                    <p><span>Subscription Type </span>: <span>{{$booking->subscription_type}}</span> </p>
                                </div>
                                <div class="bio-row">
                                ...
                                <div class="bio-row">
                                    <p><span>Subscription Renewal Date</span>: <span> <?php echo date('Y-m-d', strtotime($booking->checkout_date)); ?></span> </p>
                                </div> 
                                ...
                                <div class="bio-row" >
                                    ...
                                    <span class="value-data" style=" background: red;display: inline;padding: 5px;border-radius: 3px;color: white;">Cancelled</span>
                                    @else 
