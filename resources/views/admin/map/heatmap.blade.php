...
<script type="text/javascript" src="https://maps.google.com/maps/api/js?key={{urlencode(get_settings('google_map_key'))}}&callback=initialize&libraries=visualization" async defer></script>
...
google.maps.event.addDomListener(window, 'load', initialize);
        ...
        function initialize() {
            ...
            results.forEach(element => {
                heatmapData.push(new google.maps.LatLng(element.pick_lat, element
                    .pick_lng));
                pickLat.push(element.pick_lat)
                pickLng.push(element.pick_lng)
        ...
        $(document).on('change', '#zone', function() {
            ...
            //         success: function(results){
            //             results.forEach(element => {
            //                 heatmapData.push(new google.maps.LatLng(element.pick_lat, element.pick_lng));
            //                 pickLat.push(element.pick_lat);
            //                 pickLng.push(element.pick_lng);
