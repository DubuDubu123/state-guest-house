                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="user_type" id="user_type" class="form-control" required>
                                                ...
                                                <option value="all" {{ old('user_type',$item->user_type) == 'all' ? 'selected' : '' }} >@lang('view_pages.all')</option>
                                            </select>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <!-- <textarea class="ckeditor form-control" name="answer">{{ old('answer',$item->answer) }}</textarea> -->
                                      ...
                                      <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="name">@lang('view_pages.hyper_link')</label>
                                                <input type="text"  class="form-control"  name="hyper_link" value="{{old('hyper_link',$item->hyper_link)}}"
