  ...
  <div id="invoice" class="effect2">
    <div class="page-tools" style="text-align: right;">
      <div class="action-buttons" style="margin-bottom: 20px;">
        <a class="btn bg-white btn-light mx-1px text-95" href="{{url('/')}}/party/export_pdf/{{$booking->id}}" data-title="PDF" style="background: #86bebd !important; color: white;">
            ...
            <table class="table border-gray-200 mt-3">
              ...
              <tr>
                ...
                <tr>
                  ...
                  <td class="text-end px-0" style="text-align: right;color:red !important;font-size:12px;    padding-bottom: 12px !important;"> - ₹{{$invoice->initial_price}}</td>
                </tr> 
