                ...
                <div class="box" style="margin-bottom:0px;">
                    <div class="box-header with-border">
                        <div style="color:black;font-size:18px">
                            <h5 class="font-weight-600 p-5" style="color:black;font-size:21px">Sports Booking </h5>
                        </div>
...
"> 
                            <div id="js-types-partial-target" style=" width: 100%;">
                                <include-fragment src="sports-booking/fetch">
        ...
        <script>
            ...
            $(".book-now").click(function(){
                let url = "{{url('/')}}/sports-booking/book-now";
