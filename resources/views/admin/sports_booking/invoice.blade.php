  ...
  <div id="invoice" class="effect2">
    <div class="page-tools" style="text-align: right;">
      <div class="action-buttons" style="margin-bottom: 20px;">
        <a class="btn bg-white btn-light mx-1px text-95" href="{{url('/')}}/sports-booking/export_pdf/{{$booking->id}}" data-title="PDF" style="background: #86bebd !important; color: white;">
          ...
          <td style="text-align: right; margin-top: 10px;">
            <div class="info1">
              ...
              <p style="line-height: 14px;">
                ...
                Booked date:
                <?php  echo date('Y-m-d', strtotime($booking->created_at)); ?><br>
...
">{{$key+1}}</td>
                ...
                <tr>
                  <td class="px-0" style=" padding-top: 20px !important;">Total Amount</td>
                  <td class="text-end px-0" style="text-align: right; font-weight: bold !important;padding-top: 20px !important;">
