            ...
            <div class="col-12">
                ...
                <div class="box-header with-border">
                        <div style="color:black;font-size:18px">
                            <h5 class="font-weight-600 p-5" style="color:black;font-size:21px">Calender View </h5>
                        </div>
...
">
                            ...
                            <div id="js-types-partial-target" style=" width: 100%;">
                                <include-fragment src="{{url('/')}}/types/availability-view/fetch">
...
">Booking Confirmed Successfully</h4>
            ...
            $(function() {
                ...
                $('#search').on('click', function(e) {
                    ...
                    fetch('types/availability-view/fetch?search=' + search_keyword)
...
">Please select from and to date</div>
...
$(".apply_filter").click(function(){ 
    ...
    { 
        ...
        if(from_date != "" && from_date != null && to_date != "" && to_date != null)
        {
            ...
            status_data = 0;
            $(".resp-error").html("Please select From and To date");
            $(".resp-error").show(); 
        }
    }
    else{
    ...
    {
        $.ajax({
        url:'{{url("/")}}/types/availability-view/fetch',
        data:data,
        cache:false,
        dataType:'html',
        success:function(res)
