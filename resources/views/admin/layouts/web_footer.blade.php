    ...
    <div class="container-fluid text-dark">
      <div class="row pt-md doot">
        ...
        <div class="col-lg-2 col-sm-4 ml-lg-auto mb-5 mb-lg-0">
          ...
          <h6 class="heading ml-n5 mb-3 text-dark">Quick links</h6>
          <ul class="list-unstyled">
            <li><a href="{{ url('/') }}" class="text-dark opacity-80">Home</a></li>
            <li><a href="{{ url('serviceareas') }}" class="text-dark opacity-80">Service Locations</a></li>
            <li><a href="{{ url('compliance') }}" class="text-dark opacity-80">Compliance </a></li>
            <li><a href="{{ url('contactus') }}" class="text-dark opacity-80">Contact Us</a></li>
            <li><a href="{{ url('privacy') }}" class="text-dark opacity-80">Privacy Policy</a></li>
            <li><a href="{{ url('terms') }}" class="text-dark opacity-80">Terms & Conditions</a></li>
          </ul>
        </div>
        <div class="col-lg-2 col-sm-4 mb-5 mb-lg-0">
          <h6 class="heading ml-n5 mb-3 text-dark">Rider</h6>
          <ul class="list-unstyled">
            <!-- <li><a href="#" class="text-white opacity-80">How it works</a></li>
            <li><a href="#" class="text-white opacity-80">Rider Requirements</a></li> -->
            <li><a href="{{ url('safety') }}" class="text-dark opacity-80">Safety</a></li>
          </ul>
          <div class="row">
        ...
        <div class="col-lg-2 col-md-4 mb-5 mb-lg-0">
          <h6 class="heading ml-n5 mb-3 text-dark">Driver</h6>
          <ul class="list-unstyled text-small">
            <li><a href="{{ url('howdriving') }}" class="text-dark opacity-80">How it works</a></li>
            <li><a href="{{ url('driverrequirements') }}" class="text-dark opacity-80">Driver Requirements</a></li>
            <li><a href="{{ url('dmv') }}" class="text-dark opacity-80">DMV check</a></li>
            <li><a href="{{ url('safety') }}" class="text-dark opacity-80">Safety</a></li>
          </ul>
          <div class="row">
            <div class="col-md-12 mb-1">
      ...
      <div class="row align-items-center justify-content-md-between py-4 mt-4 delimiter-top border-top">
        <div class="col-md-6">
          <div class="copyright font-size-xs text-center text-md-left text-dark">
