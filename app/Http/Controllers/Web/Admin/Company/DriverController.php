...
class DriverController extends BaseController
{
    ...
    */
    public function index()
    {
        ...
        $sub_menu_1 = '';
        return view('admin.company-driver.drivers.index', compact('page', 'main_menu', 'sub_menu','sub_menu_1'));
    }
    ...
    */
    public function create()
    {
        ...
        return view('admin.company-driver.drivers.create', compact('services', 'types', 'page', 'countries', 'main_menu', 'sub_menu', 'companies', 'carmake','sub_menu_1'));
    }
    ...
    public function getById(Driver $driver)
    {
        ...
        return view('admin.company-driver.drivers.update', compact('item', 'services', 'types', 'page', 'countries', 'main_menu', 'sub_menu', 'companies', 'carmake', 'carmodel','sub_menu_1'));
    }
   ...
   public function toggleApprove(Driver $driver)
    ...
    public function profile(Driver $driver){
        ...
        return view('admin.company-driver.drivers.profileview', compact('item', 'page', 'main_menu', 'sub_menu','sub_menu_1'));
    }
    ...
    public function hireDriverView(){
        ...
        return view('admin.company-driver.drivers.hire', compact('page', 'main_menu', 'sub_menu','sub_menu_1'));
    }
    ...
    public function fleetPrivilegeView(Driver $driver){
        ...
        return view('admin.company-driver.drivers.fleet_privilege', compact('page', 'main_menu', 'sub_menu','driver','fleets','sub_menu_1'));
    }
