...
class RoleController extends BaseController
{
    ...
    public function index(QueryFilterContract $queryFilter)
    {
        if (access()->hasRole(RoleSlug::SUPER_ADMIN)) {
            $result = Role::whereIn('slug', RoleSlug::mobileAppRoles());
        } else {
        ...
        return view('admin.master.roles.index', compact('results', 'page', 'main_menu', 'sub_menu','sub_menu_1'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.master.roles.addRole', compact('page', 'permissions', 'main_menu', 'sub_menu','sub_menu_1'));
    }
    ...
    public function getById($id)
    {
        ...
        return view('admin.master.roles.editRole', compact('role', 'permissions', 'page', 'main_menu', 'sub_menu','sub_menu_1'));
    }
    ...
    public function fetch(QueryFilterContract $queryFilter)
    {
        ...
        return view('admin.master.roles._fetch', compact('results'));
    }
    /**
     * create the Role.
     *
    ...
    public function assignPermissionView($id)
    {
        ...
        return view('admin.master.roles.assignPermissions', compact('role', 'permissions', 'page', 'main_menu', 'sub_menu','sub_menu_1'));
    }
