...
class OwnerNeededDocumentController extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('admin.master.owner_needed_doc.index', compact('page', 'main_menu', 'sub_menu', 'sub_menu_1'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.master.owner_needed_doc.create', compact('page', 'main_menu', 'sub_menu','format', 'sub_menu_1'));
    }
    ...
    public function getById(OwnerNeededDocument $neededDoc)
    {
        ...
        return view('admin.master.owner_needed_doc.update', compact('item', 'page', 'main_menu', 'sub_menu','format', 'sub_menu_1'));
    }
