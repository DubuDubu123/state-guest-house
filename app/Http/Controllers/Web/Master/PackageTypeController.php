...
class PackageTypeController extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('admin.master.package_type.index', compact('page', 'main_menu', 'sub_menu', 'sub_menu_1'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.master.package_type.create', compact('page', 'main_menu', 'sub_menu', 'sub_menu_1'));
    }
...
// dd($created_params);
     ...
     public function getById(PackageType $package)
    {
        ...
        return view('admin.master.package_type.update', compact('item', 'page', 'main_menu', 'sub_menu', 'sub_menu_1'));
    }
