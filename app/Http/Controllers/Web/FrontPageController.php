...
class FrontPageController extends Controller
{
    ...
    public function serviceareaspage()
    {
        ...
        $sub_menu_1 = '';
        return view ('webfront.serviceareas',compact('data','p','serv','main_menu','sub_menu', 'sub_menu_1'));
    ...
    public function safetypagecms()
    {
        ...
        $sub_menu_1 = '';
        return view ('admin.cms.safetypage_cms',compact('data','p','main_menu','sub_menu', 'sub_menu_1'));
    }
    ...
    public function playstorepagecms()
    {
        ...
        $sub_menu_1 = '';
        return view ('admin.cms.playstore_cms',compact('data','main_menu','sub_menu', 'sub_menu_1'));
    }
    ...
    public function footerpagecms()
    {
        ...
        $sub_menu_1 = '';
        return view ('admin.cms.footer_cms',compact('data','p','main_menu','sub_menu', 'sub_menu_1'));
    }
   ...
   public function drreqpagecms()
    {
        ...
        $sub_menu_1 = '';
        return view ('admin.cms.driverreqpage_cms',compact('data','p','main_menu','sub_menu', 'sub_menu_1'));
    }
   ...
   public function contactpagecms()
    {
     ...
     $main_menu = 'settings';
        ...
        $sub_menu_1 = '';
        return view ('admin.cms.contactpage_cms',compact('data','p','main_menu','sub_menu', 'sub_menu_1'));
    }
   ...
   public function howdriverpagecms()
    {
     ...
     $main_menu = 'settings';
        ...
        $sub_menu_1 = '';
        return view ('admin.cms.howdriverpage_cms',compact('data','p','main_menu','sub_menu', 'sub_menu_1'));
    }
   ...
   public function applydriverpagecms()
    {
     ...
     $main_menu = 'settings';
        ...
        $sub_menu_1 = '';
        return view ('admin.cms.applydrivepage_cms',compact('data','p','main_menu','sub_menu', 'sub_menu_1'));
    }
   ...
   public function privacypagecms()
    {
     ...
     $main_menu = 'settings';
        ...
        $sub_menu_1 = '';
        return view ('admin.cms.privacypage_cms',compact('data','main_menu','sub_menu', 'sub_menu_1'));
    }
   ...
   public function dmvpagecms()
   {
     ...
     $main_menu = 'settings';
        ...
        $sub_menu_1 = '';
        return view ('admin.cms.dmvpage_cms',compact('data','main_menu','sub_menu', 'sub_menu_1'));
    }
   ...
   public function termspagecms()
   {
     ...
     $main_menu = 'settings';
        ...
        $sub_menu_1 = '';
        return view ('admin.cms.termspage_cms',compact('data','main_menu','sub_menu', 'sub_menu_1'));
    }
    ...
    public function complaincepagecms()
   {
     ...
     $main_menu = 'settings';
        ...
        $sub_menu_1 = '';
        return view ('admin.cms.complaincepage_cms',compact('data','main_menu','sub_menu', 'sub_menu_1'));
    }
    ...
    public function colorthemepagecms()
   {
     ...
     $main_menu = 'settings';
        ...
        $sub_menu_1 = '';
        return view ('admin.cms.colortheme_cms',compact('data','p','main_menu','sub_menu', 'sub_menu_1'));
    }
    ...
    public function servicepagecms()
    {
     ...
     $main_menu = 'settings';
        ...
        $sub_menu_1 = '';
        return view ('admin.cms.serviceareas_cms',compact('data','p','serv','main_menu','sub_menu', 'sub_menu_1'));
    }
    ...
    public function frontpage()
    {
     ...
     $main_menu = 'settings';
        ...
        //return redirect()->back()->with('success', $message)
          //                        ->with('p');
        return view ('admin.cms.frontpage_cms',compact('data','p','main_menu','sub_menu', 'sub_menu_1'));
    }
