...
use App\Models\Admin\BasePriceRange;
...
class ZoneType extends Model
{
     ...
     */
    protected $fillable = [
        'zone_id', 'type_id','payment_type','active','bill_status','order_by'
    ];
    ...
    */
    ...
    {
        return $this->hasMany(PriceRange::class, 'zone_type_id', 'id');
    }
    public function basePriceRange()
    {
        return $this->hasMany(BasePriceRange::class, 'zone_type_id', 'id');
    }
