...
class VehicleType extends Model
{
     ...
     */
    protected $fillable = [
         'name', 'icon', 'capacity','is_accept_share_ride','active','company_key','description','supported_vehicles','short_description','is_taxi' , 'icon_types_for','created_by','updated_by'
    ];
