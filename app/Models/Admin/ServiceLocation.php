...
class ServiceLocation extends Model
{
    ...
    protected $fillable = ['name','currency_name','currency_code','currency_symbol','country','timezone','active','company_key','created_by','updated_by'];
    ...
    */
    ...
    {
        return $this->hasMany(Driver::class, 'service_location_id', 'id');
    }
