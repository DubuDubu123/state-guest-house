...
class Driver extends Model
{
   ...
   public function owner()
    ...
    {
        return $this->hasOne(DriverInvoice::class, 'driver_id', 'id');
    }
    /**
    ...
    */
    ...
    {
        return $this->hasMany(DriverCancellationFee::class, 'driver_id', 'id');
    }
    ...
    */
    ...
    {
        return $this->hasMany(RequestRating::class, 'driver_id', 'id');
    }
    ...
    */
    ...
    {
        $latest_cancellation_fee = $this->driverCancellationFee()->latest()->first();
