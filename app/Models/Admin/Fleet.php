...
class Fleet extends Model
{
    ...
    protected $fillable = [
        'owner_id','brand','model','license_number','permission_number','vehicle_type','active','fleet_id','qr_image','approve','car_color','driver_id','vehicle_insurence_number','rc_number','created_by','updated_by'
    ];
