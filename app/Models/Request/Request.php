...
use App\Models\Request\LiveRequest;
...
class Request extends Model
{
    ...
    */
    ...
    {
        return $this->hasOne(LiveRequest::class, 'request_id', 'id');
    } 
    ...
    {
        return $this->hasMany(DriverRejectedRequest::class, 'request_id', 'id');
    }
    ...
    {
        return $this->belongsTo(AdminDetail::class, 'dispatcher_id', 'id');
    }
    ...
    {
        return $this->hasOne(UserCancellationFee::class, 'request_id', 'id');
    }
     ...
     * @return \Illuminate\Database\Eloquent\Relations\hasOne
     */
    public function driverCancellationFee()
    {
        return $this->hasOne(DriverCancellationFee::class, 'request_id', 'id');
    }
